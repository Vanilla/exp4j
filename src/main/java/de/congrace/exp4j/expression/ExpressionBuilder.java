...
public class ExpressionBuilder {
	 ...
	 * @throws UnknownFunctionException when an unrecognised function name is used in the expression.
	 ...
	 *
	 * @param variableNames collection of {@link String} of the variable names used in the expression.
